...
body
  {background-image:url('images/BiuBiuPanda_project_final_backgroundCN.jpg');background-size:cover;background-color:white;background-repeat:no-repeat;background-attachment:fixed;}
.page
  {
    width: 1000px;
    height: 500px;
...
<div class="page">
  <div class="mid">
    <form method="POST" action="BiuBiuPanda_project_final_mini_gameCN.php" id="questionForm">
      <p class="bigfont">请回答下列问题: </p>
      <p id="getQuestion"></p>
      <input type="text" name="answerBar" size="75">
      <input type="submit" value="确定" name="AnswerButton">
    </form>
...
function randomSelect(){
  ...
  if(selectedType == 1){
    ...
    question += "\"type1\"><p>任写出一首" + artist + "唱过/作曲过/作词过的歌</p>";
  }
  else if(selectedType == 2){
    var nationality = document.getElementById("nationality").value;
    question += "\"type2\"><p>任写出一名" + nationality + "歌手，TA有至少一首歌被收录在专辑中</p>";
  }
  else{ // selectedType == 3
    var artist = document.getElementById("nArtist").value;
    question += "\"type3\"><p>谁和" + artist + "一起创作同一首歌的经历最多？</p>";
  }
